 '''###TODO: Allow for character selection and naming 
 '''
...
enemies = [
    Mortal("Goblin Archer 1", 12, 12),
    Mortal("Goblin Archer 2", 12, 12),
    Mortal("Goblin Archer 3", 12, 12),
    Mortal("Goblin Boss", 14, 30)
]

players = [
    Mortal("Barbarian", 16, 40),
    Mortal("Wizard", 13, 25)
]
